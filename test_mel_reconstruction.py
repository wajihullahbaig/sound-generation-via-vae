...
file_path = 'C:\\Users\\Acer\\work\\git\\free-spoken-digit-dataset\\recordings\\1_george_36.wav'

waveform, sr = torchaudio.load(file_path)
#if waveform.shape[1] > sr * 5:  # Trim to 5 seconds if longer
...
# 4. Reverse the mel spectrogram to audio
...
torchaudio.save('reconstructed_audio.wav', y_reverse, sr)

# 6. Plot the waveforms for comparison
plt.figure(figsize=(12, 8))
plt.subplot(2, 1, 1)
plt.plot(waveform[0].numpy())
plt.title('Original Audio')
plt.subplot(2, 1, 2)
plt.plot(y_reverse[0].numpy())
